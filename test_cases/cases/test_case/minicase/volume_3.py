...
def case():
    ...
    """先创建1G"""
    quota_common.creating_files(nodeip_lst[0], TEST_PATH, 1024, 1, "a")
    ...
    quota_common.creating_files(nodeip_lst[0], TEST_PATH, 2048, 1, "b")
    ...
    log.info("4> 更新卷，改大total_bytes为3G")
    ...
    log.info('5> 再创建2G')
    quota_common.creating_files(nodeip_lst[0], TEST_PATH, 2048, 1, "c")
