...
def case():
    ...
    make_fault.kill_process(node_ip, process_name)
    event_common.check_alarms_result(code, "oPara alarm check right")
    cmd1 = "mv /home/parastor/bin/oPara_bk /home/parastor/bin/oPara"
