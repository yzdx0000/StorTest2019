...
def case():
    ...
    p1 = Process(target=obj_vdb.run_create, args=(EVENT_TRUE_PATH, '/tmp', snap_common.CLIENT_IP_1))
    ...
    cmd = "mv /home/parastor/bin/oStor /home/parastor/bin/oStor_bk"
    rc, stdout = common.run_command(node_ip, cmd)
    common.judge_rc(rc, 0, "mv oPara wrong")
    make_fault.kill_process(node_ip, process_name)

    event_common.check_alarms_result(code, "oStor alarm check right")
    # 恢复环境
    cmd1 = "mv /home/parastor/bin/oStor_bk /home/parastor/bin/oStor"
