...
#   3、执行pause_jobengine，输入参数错误，预期下发失败
...
def case():
    ...
    select_type = jobengine_types[3]  # 支持手动启动、暂停、取消的只有RMFS
    ...
    rc, stdout = common.pause_jobengine(select_type, 0)
    if 0 != rc:
        log.error('pause jobengine failed !!!')
