...
#   执行：
#           1>删除FTP共享
#           2>执行get_events查看删除FTP共享成功的结果显示
#           3>清理工作
# @changelog：
####################################################################################
...
ftp_path = nas_common.ROOT_DIR + "FTP_" + FILE_NAME  # parastor:/nas/FTP_events_5_3_3_73
...
def case():
    ...
    time.sleep(delay_time)  # 删除FTP共享成功，延时
    code = '0x02030805'   # 删除FTP共享成功对应编号
    description = 'delete_ftp_exports'
    '''删除FTP共享成功事件码是否在事件列表中'''
