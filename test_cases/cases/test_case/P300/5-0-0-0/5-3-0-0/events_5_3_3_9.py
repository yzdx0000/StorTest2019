...
def case():
    ...
    '''1>制作修改业务子网成功事件'''
    update_subnet_name = FILE_NAME + "_SUBNET"+"_Update"  # 修改业务子网的名字
    check_result = nas_common.update_subnet(subnet_id, 
    ...
    time.sleep(delay_time)    # 修改业务子网成功后，延时
    code = '0x02030203'     # 修改业务子网成功事件对应的编号
    description = 'update_subnet'
    '''修改业务子网成功事件码是否在事件列表中'''
