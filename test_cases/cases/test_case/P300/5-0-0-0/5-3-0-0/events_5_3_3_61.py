...
#   执行：
#           1>创建SMB客户端授权
#           2>执行get_events查看创建SMB客户端授权成功的结果显示
#           3>清理工作
# @changelog：
####################################################################################
...
smb_path = nas_common.ROOT_DIR + "SMB_" + FILE_NAME                     # parastor:/nas/SMB_events_5_3_3_61
...
def case():
    ...
    time.sleep(delay_time)               # 创建SMB客户端授权成功，延时
    code = '0x02030707'                # 创建SMB客户端授权成功对应编号
    description = 'add_smb_export_auth_clients'
    '''创建SMB客户端授权成功事件码是否在事件列表中'''
