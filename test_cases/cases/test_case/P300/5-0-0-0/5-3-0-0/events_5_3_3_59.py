...
#   执行：
#           1>删除SMB共享
#           2>执行get_events查看删除SMB共享成功的结果显示
#           3>清理工作
# @changelog：
####################################################################################
...
smb_path = nas_common.ROOT_DIR + "SMB_" + FILE_NAME  # parastor:/nas/SMB_events_5_3_3_59
...
def case():
    ...
    time.sleep(delay_time)  # 删除SMB共享成功，延时
    code = '0x02030705'   # 删除SMB共享成功对应编号
    description = 'delete_smb_exports'
    '''删除SMB共享成功事件码是否在事件列表中'''
