...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：11-0-1-27 目录物理空间配额混合阈值，建议阈值先生效，
#         软阈值其次生效，限期内硬阈值不生效
#######################################################
...
#    time.sleep(86400)
    ...
    # 检查配额是否生效
    if quota_common.dir_total_file_size(quota_common.CLIENT_IP_1, quota_common.QUOTA_PATH) != "3514M":  # 3012M+502M
        raise Exception("11-0-1-27 Failed")
    else:
        log.info("11-0-1-27 Succeed")
...
class Quota_Class_11_0_1_27():
    def quota_method_11_0_1_27(self):
