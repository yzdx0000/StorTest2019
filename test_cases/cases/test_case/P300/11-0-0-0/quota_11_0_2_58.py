...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：11-0-2-58 修改目录用户组配额规则，使规则参数不合法
#######################################################
...
def executing_case():
    ...
    # 创建一个目录用户组配额规则【临时--filenr_grace_time=600，--logical_grace_time=600】
    ...
    total_inodes = quota_common.group_total_inodes(quota_common.NOTE_IP_1, quota_common.QUOTA_PATH,
    ...
    if (check_result1["detail_err_msg"] != "" or
        ...
        log.error("11-0-2-58 Failed")
        raise Exception("11-0-2-58 Failed")
    else:
        log.info("11-0-2-58 Succeed")
    return
...
class Quota_Class_11_0_2_58():
    def quota_method_11_0_2_58(self):
