...
def executing_case():
    ...
    if check_result1["detail_err_msg"] != "" \
        ...
        common.judge_rc(rc, 0, "get quota failed")
        log.error("11-0-2-16 Failed")
        raise Exception("11-0-2-16 Failed")
    else:
        log.info("11-0-2-16 Succeed")
    return
...
class Quota_Class_11_0_2_16():
    def quota_method_11_0_2_16(self):
