...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：11-0-2-54 修改目录用户组配额规则之改大、改小硬阈值
#######################################################
...
def executing_case():
    ...
    if (check_result1["detail_err_msg"] != "" or
        ...
        rc, check_result = quota_common.get_all_quota_info()
        common.judge_rc(rc, 0, "get quota failed")
        log.error("11-0-2-54 Failed")
        raise Exception("11-0-2-54 Failed")
    else:
        log.info("11-0-2-54 Succeed")
    return
...
class Quota_Class_11_0_2_54():
    def quota_method_11_0_2_54(self):
