...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：11-0-1-31 目录用户inode数配额硬阈值
#######################################################
...
def executing_case():
    ...
    quota_common.creating_files(quota_common.CLIENT_IP_1, quota_common.QUOTA_PATH,
                                1, 1, "e")
    user_file_list = quota_common.get_file_list(quota_common.CLIENT_IP_1, quota_common.QUOTA_PATH, "e")
    quota_common.change_file_user(quota_common.CLIENT_IP_1, quota_common.QUOTA_PATH,
                                  user_file_list, quota_common.QUOTA_USER)
    ...
    if total_inodes != 2000:
        ...
        log.error("11-0-1-31 Failed")
        raise Exception("11-0-1-31 Failed")
    else:
        log.info("11-0-1-31 Succeed")
    return
...
class Quota_Class_11_0_1_31():
    def quota_method_11_0_1_31(self):
