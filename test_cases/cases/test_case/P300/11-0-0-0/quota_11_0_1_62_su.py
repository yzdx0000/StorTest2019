...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：11-0-1-62_su 目录用户组inode数配额软阈值之su方式
#######################################################
...
def executing_case():
    ...
    quota_common.creating_files_by_designated_user_or_group(quota_common.CLIENT_IP_1, quota_common.QUOTA_PATH,
                                                            soft_val, 1, "e", quota_common.QUOTA_USER)
    ...
    if total_inodes != (2000 + soft_val):
        ...
        log.error("11-0-1-62_su Failed")
        raise Exception("11-0-1-62_su Failed")
    else:
        log.info("11-0-1-62_su Succeed")
    return
...
class Quota_Class_11_0_1_62_su():
    def quota_method_11_0_1_62_su(self):
