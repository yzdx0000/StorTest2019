...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：11-0-1-65 目录用户组inode数配额混合阈值，软阈值最小
#######################################################
...
def executing_case():
    ...
    if check_result["err_no"] == 0:
        ...
        log.error("11-0-1-65 Failed")
        raise Exception("11-0-1-65 Failed")
    else:
        log.info("11-0-1-65 Succeed")
    return
...
class Quota_Class_11_0_1_65():
    def quota_method_11_0_1_65(self):
