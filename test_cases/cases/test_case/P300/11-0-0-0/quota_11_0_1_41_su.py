...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：11-0-1-41_su 目录用户逻辑空间配额软阈值之su方式
#######################################################
...
def executing_case():
    ...
    if total_file_size != quota_common.FILE_SIZE_1M * (soft_val_2 + 2048):
        ...
        log.error("11-0-1-41_su Failed")
        raise Exception("11-0-1-41_su Failed")
    else:
        log.info("11-0-1-41_su Succeed")
    return
...
class Quota_Class_11_0_1_41_su():
    def quota_method_11_0_1_41_su(self):
