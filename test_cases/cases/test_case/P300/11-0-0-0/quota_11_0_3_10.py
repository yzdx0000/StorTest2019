...
# Date: 2018-09-03
# @summary：
#    用户：对父目录a创建硬阈值配额2000，创建子目录b硬阈值为1000，子目录写1000个文件，再写1个文件失败
...
def case():
    ...
    dir1_1_inode = quota_common.user_total_inodes(quota_common.CLIENT_IP_1, dir1_1, quota_common.QUOTA_USER)
    ...
    dir1_1_inode = quota_common.user_total_inodes(quota_common.CLIENT_IP_3, dir1_1, quota_common.QUOTA_USER)
    if dir1_1_inode != 1000:
        rc_lst[sys._getframe().f_lineno] = 'dir: %s total_inode: %s ' % (dir1_1, dir1_1_inode)
