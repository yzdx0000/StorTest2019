...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：11-0-1-25 目录物理空间配额混合阈值，建议阈值先生效，
#         硬阈值其次生效
#######################################################
...
def executing_case():
    ...
    if quota_common.dir_total_file_size(quota_common.CLIENT_IP_1, quota_common.QUOTA_PATH) != "3012M":
        raise Exception("11-0-1-25 Failed")
    else:
        print "11-0-1-25 Succeed"
...
def preparing_environment():
    ...
    2、创建配额测试相关的目录和文件
    '''
    # 针对目录配置物理空间为3G硬阈值、4G软阈值（宽限天数为1天）、2G建议阈值的配额
...
class Quota_Class_11_0_1_25():
    def quota_method_11_0_1_25(self):
