...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：11-0-1-24 目录物理空间配额混合阈值，软阈值先生效，限
#         期内硬阈值不生效
#######################################################
...
#    time.sleep(86400)
    ...
    if quota_common.dir_total_file_size(quota_common.CLIENT_IP_1, quota_common.QUOTA_PATH) != "2510M":  # 2008M+502M
        raise Exception("11-0-1-24 Failed")
    else:
        log.info("11-0-1-24 Succeed")
...
class Quota_Class_11_0_1_24():
    def quota_method_11_0_1_24(self):
