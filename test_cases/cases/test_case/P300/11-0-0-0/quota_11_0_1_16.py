...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：11-0-1-16 目录逻辑空间配额混合阈值，硬阈值小于软阈值
#######################################################
...
def executing_case():
    ...
    2、结果检查
    '''
    # 针对目录配置逻辑空间为3G硬阈值、4G软阈值（宽限天数为1天）、2G建议阈值的配额
    ...
    if check_result["err_no"] == 0:
        ...
        log.error("11-0-1-16 Failed")
        raise Exception("11-0-1-16 Failed")
    else:
        log.info("11-0-1-16 Succeed")
    return
...
class Quota_Class_11_0_1_16():
    def quota_method_11_0_1_16(self):
