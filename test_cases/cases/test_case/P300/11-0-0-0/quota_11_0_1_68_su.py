...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：11-0-1-68_su 目录用户组inode数配额混合阈值，建议阈值先生
...
def executing_case():
    ...
    if total_inodes != (3000 + soft_val_2):
        ...
        log.error("11-0-1-68_su Failed")
        raise Exception("11-0-1-68_su Failed")
    else:
        log.info("11-0-1-68_su Succeed")
    return
...
class Quota_Class_11_0_1_68_su():
    def quota_method_11_0_1_68_su(self):
