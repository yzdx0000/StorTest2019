...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：11-0-1-39 目录用户inode数配额混合阈值，建议阈值先生
...
#    time.sleep(86400)
    ...
    if total_inodes != (3000 + soft_val):
        ...
        log.error("11-0-1-39 Failed")
        raise Exception("11-0-1-39 Failed")
    else:
        log.info("11-0-1-39 Succeed")
    return
...
class Quota_Class_11_0_1_39():
    def quota_method_11_0_1_39(self):
