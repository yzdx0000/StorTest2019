...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：11-0-1-75 目录用户组逻辑空间配额混合阈值，硬阈值最小
#######################################################
...
def executing_case():
    ...
    if rc == 0:
        ...
        log.error("11-0-1-75 Failed")
        raise Exception("11-0-1-75 Failed")
    else:
        log.info("11-0-1-75 Succeed")
    return
...
class Quota_Class_11_0_1_75():
    def quota_method_11_0_1_75(self):
