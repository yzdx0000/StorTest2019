...
SNAP_TRUE_PATH = os.path.join(snap_common.SNAP_PATH, FILE_NAME)              #/mnt/liyao/snap/snap_13_1_2_18
CREATE_SNAP_PATH = os.path.join(snap_common.SNAP_PATH_BASENAME, FILE_NAME)   #/snap/snap_13_1_2_18


def case():
    # 在目录/mnt/liyao/snap_13_1_2_18下创建文件test_file1
    ...
    # 对目录/mnt/liyao/snap/snap_13_1_2_18创建快照
    ...
    # 对文件/mnt/liyao/snap/snap_13_1_2_18/test_file1创建快照
