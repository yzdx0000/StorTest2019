...
#   12、按照a4、a1、a3、a5、a2（a2需要跑vdbench 01脚本进行数据校验）的顺序依次revert，观察快照源目录情况；
#   13、删除快照；
#   14、3个客户端检查是否有快照路径入口；
#
# changelog:
...
SNAP_TRUE_PATH = os.path.join(snap_common.SNAP_PATH, FILE_NAME)             #/mnt/wangguanglin/snap/snap_13_0_5_19
CREATE_SNAP_PATH = os.path.join(snap_common.SNAP_PATH_BASENAME, FILE_NAME)  #/snap/snap_13_0_5_19


def case():
    """对目录/mnt/wangguanglin/snap/snap_13_0_5_19创建快照1"""
    ...
    """客户端2对目录/mnt/wangguanglin/snap/snap_13_0_5_19执行vdbench 修改文件内容"""
    tool_use.vdbench_run(test_dir, snap_common.CLIENT_IP_1, snap_common.CLIENT_IP_2, run_write=True)

    """对目录/mnt/wangguanglin/snap/snap_13_0_5_19创建快照3"""
    ...
    """客户端3修改/mnt/wangguanglin/snap/snap_13_0_5_19权限"""
    cmd = 'chmod 522 %s' % SNAP_TRUE_PATH
    common.run_command(snap_common.CLIENT_IP_1, cmd)

    """对目录/mnt/wangguanglin/snap/snap_13_0_5_19创建快照4"""
    ...
    """客户端1修改/mnt/wangguanglin/snap/snap_13_0_5_19/vdbench目录名"""
    test_dir1 = os.path.join(SNAP_TRUE_PATH, 'vdbench1')
    cmd = 'mv %s %s' % (test_dir, test_dir1)
    common.run_command(snap_common.CLIENT_IP_1, cmd)

    """对目录/mnt/wangguanglin/snap/snap_13_0_5_19创建快照5"""
    ...
    """对目录/mnt/wangguanglin/snap/snap_13_0_5_19校验目录里面的内容是否为空的"""
    ...
    """对目录/mnt/wangguanglin/snap/snap_13_0_5_19校验目录里面的内容是否为目录vdbench1"""
    cmd = 'ls %s' % SNAP_TRUE_PATH
    rc, stdout = common.run_command(snap_common.CLIENT_IP_1, cmd)
    ...
    """客户端2对目录/mnt/wangguanglin/snap/snap_13_0_5_19执行vdbench 01 脚本(校验数据一致性)"""
