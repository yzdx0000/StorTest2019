...
SNAP_TRUE_PATH = os.path.join(snap_common.SNAP_PATH, FILE_NAME)              #/mnt/liyao/snap/snap_13_1_2_23
CREATE_SNAP_PATH = os.path.join(snap_common.SNAP_PATH_BASENAME, FILE_NAME)   #/snap/snap_13_1_2_23
...
def case():
    ...
    md5_lst_2 = []
    for i in range(10):
        snap_file = os.path.join(snap_common.SNAPSHOT_PAHT, 'snap_13_1_2_23_snapshot_%d' % i)
