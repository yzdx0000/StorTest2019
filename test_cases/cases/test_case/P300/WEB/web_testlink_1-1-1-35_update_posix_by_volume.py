...
# 脚本作者：duyuli
# 日期：2018-12-28
# testlink case: 3.0-51051
#######################################################

FILE_NAME = os.path.splitext(os.path.basename(__file__))[0]                  # 本脚本名字
client_ips_list = get_config.get_allclient_ip()
volume_name = "volume2"
volume_name_list_update = ["volume1", "volume2"]
...
def case():
    ...
    # 修改授权卷
    obj_web_client_auth.update_posix_auth(volume_name, volume_name_list=volume_name_list_update)
