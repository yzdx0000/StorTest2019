...
# 脚本作者：duyuli
# 日期：2018-12-22
# testlink case: 3.0-51020~3.0-51021
#######################################################
...
def get_tar_path():
    ...
    dir_path = get_config.get_web_pkg_position()
    cmd2 = "ls %s | grep parastor-3.0.0-centos7.5 | grep .tar" % dir_path
    rc, stdout2 = common.run_command(web_ip, cmd2)
    stdout2 = stdout2.strip()
    path = os.path.join(dir_path, stdout2)
    return path
