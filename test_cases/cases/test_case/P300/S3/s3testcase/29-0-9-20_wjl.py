...
# *******************************************
# 设置账户ACL函数
# 设置ACL，key=1;将acc1的object赋予acc2读权限。
...
def case():
    ...
    opt2 = acl_set_write(
        ...
        accid2,
        key="1")
    log.info("5.2> ACL读权限验证")
    rc_l2, opt_l2 = confirm_acl(
        bucket_name1, object_name1, ak2, accid1, accid2, key="1")

    if "200 OK" in opt1 and "200 OK" in opt2 and md5_o == opt_l2[1] and "403" in opt_l2[0]\
