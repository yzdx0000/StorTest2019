...
def case():
    ...
    del_object_lst = [
        ...
        object_name_lst[3],
        object_name_lst[6]]
    rc, stdout = s3_common.multi_del_object(
        bucket_name, del_object_lst, certificate_id)
    common.judge_rc(rc, 0, 'multi delete object failed!')
    log.info("appoint object delete success!")

    log.info("7> 获取账户内所有的桶下的对象")
