...
def case():
    ...
    log.info("6> 删除桶，并给查询账户设置所有者账户桶的ACL权限")
    ACL_TYPE = "FULL_CONTROL"
    threads = []
    thread1 = MyThread(s3_common.del_bucket, args=(bucket_name, certificate_id, ))
    thread2 = MyThread(s3_common.set_bucket_acl, args=(bucket_name, certificate_id, account_id, ACCOUNT_EMAIL,
