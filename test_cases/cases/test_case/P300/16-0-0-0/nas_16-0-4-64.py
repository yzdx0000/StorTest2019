...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：16-0-x-x 开启home目录，DOS Attributes关闭
#######################################################
...
def executing_case():
    """
        1、设置home目录后，再关闭enable_dos_attributes参数；
        pscli --command=update_smb_global_config --id=1 --home_dir="parastor:/homes" --enable_dos_attributes=false
    :return:
    """
    ...
    create_file_path = nas_common.ROOT_DIR + "homes-nas_16-0-4-64_dir"
    ...
    if allow_create_ntfs_acl != True \
            or enable_alternative_datasource != False \
            or enable_change_notify != True \
            or enable_dos_attributes != False \
            or enable_guest != False \
            or enable_ntfs_acl != True \
            or enable_oplocks != True \
            or enable_os2style_ex_attrs != False \
    ...
    # 环境恢复，enable_dos_attributes="true"
