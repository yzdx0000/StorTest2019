...
def executing_case():
    ...
    check_result = nas_common.delete_smb_exports(ids=not_exist_id)
    if check_result["detail_err_msg"].find("Cat not find smb export resource by id") == -1:
