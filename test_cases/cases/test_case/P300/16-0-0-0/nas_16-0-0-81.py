...
def executing_case():
    """
        ...
        4、修改认证域名；
        pscli --command=update_auth_provider_nis --domain_name=xxx
    ...
    wrong_auth_provider_domain_name = "wrong-nis-domain-name"

    check_result1 = nas_common.add_auth_provider_nis(name="nas_16_0_0_81_nis_auth_name",
    ...
    if cmp(auth_provider,{
                ...
                "key": int("%s" % result),
                "name": "nas_16_0_0_81_nis_auth_name",
                "type": "NIS",
                "version": 0
            }):
        log.error(("%s Failed") % FILE_NAME)
    ...
    check_result4 = nas_common.update_auth_provider_nis(provider_id=result,
                                                        domain_name=wrong_auth_provider_domain_name)
