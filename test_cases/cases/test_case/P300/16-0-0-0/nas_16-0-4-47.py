...
def executing_case():
    """
        1、修改smb共享的描述信息；
        pscli --command=update_smb_export --id=x --description=xxx
    :return:
    """
    ...
    create_file_path = nas_common.ROOT_DIR + "nas_16-0-4-47_dir"
    description_old = "nas_0-4-47.py, old description."
    description_new = "nas_0-4-47.py, new description."
    ...
    check_result2 = nas_common.create_smb_export(access_zone_id=access_zone_id,
                                                export_name="nas_16_0_4_47_smb_export_name",
                                                export_path=create_file_path,
                                                description="\"%s\"" % description_old)
