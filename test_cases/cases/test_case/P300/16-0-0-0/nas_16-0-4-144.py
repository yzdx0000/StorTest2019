...
def executing_case():
    """
        ...
        pscli --command=create_ftp_export --access_zone_id=1 --export_name=ftp_export_name --export_path=volume:/export/dir --description=bandwidth_limit_10MB/s --bandwidth_limit=10
    :return:
    """
    ...
    # create_ftp_export
    export_name = "nas_16_0_4_144_ftp_export_name"
    ...
    check_result3 = nas_common.create_ftp_export(access_zone_id=access_zone_id,
                                                 ...
                                                 upload_local_max_rate=1000,
                                                 download_local_max_rate=1000)
