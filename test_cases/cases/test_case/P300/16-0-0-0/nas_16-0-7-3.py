...
def executing_case():
    ...
    4、修改dns_addresses；
    pscli --command=update_auth_provider_ad --id=x --dns_addresses=250.250.250.250
    :return:
    """
    log.info("（2）executing_case")

    # for add_auth_provider_ad
    auth_provider_ad_name = "nas_16_0_7_3_ad_auth_name"
    ...
    # node_ids = "1,2,3"
    access_zone_name = "nas_16_0_7_3_access_zone_name"
