...
def executing_case():
    """
        1、创建一个描述信息为“old_export_description”的FTP共享；
        pscli --command=create_ftp_export --access_zone_id=1 --export_name=ftp_export_name --export_path=volume:/export/dir --description=old_export_description
        2、修改上述FTP共享的描述信息为“new_export_description”；
        pscli --command=update_ftp_export --id=x --description=new_export_description
    :return:
    """
    ...
    # create_ftp_export
    export_name = "nas_16_0_4_146_ftp_export_name"
    ...
    check_result3 = nas_common.create_ftp_export(access_zone_id=access_zone_id,
                                                 ...
                                                 description="old_export_description")
    ...
    check_result5 = nas_common.update_ftp_export(id=result,
                                                 description="new_export_description")
