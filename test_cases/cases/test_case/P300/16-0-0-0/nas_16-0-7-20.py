...
# Date: 2018-08-04
# @summary：
#   create_smb_export使用有效的authorization_ip
# @steps:
...
#   2、mstsc到authorization_ip指定范围内的windows上去挂载smb客户端；
# @changelog：
#   2018-08-07: jiangxiaoguang，增加挂载结果查询
######################################################
...
def executing_case():
    ...
    auth_provider_name = 'nas_16_0_7_20_ad_auth_name'
    ...
    unix_id_range = [1000, 1099]
    # for create_access_zone
    node_ids = '1,2,3'
    access_zone_name = 'nas_16_0_7_20_access_zone_name'
    # for create_file
    dir_name = 'nas_16-0-7-20_dir'
    create_file_path = nas_common.ROOT_DIR + dir_name
    # for create_smb_export，不配authorization_ip即允许所有ip
    export_name = 'nas_16_0_7_20_smb_export_name'
