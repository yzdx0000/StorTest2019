...
def executing_case():
    """
        1、修改smb共享的NTFSACL配置；
        pscli --command=update_smb_export --id=x --enable_ntfs_acl=true
        pscli --command=update_smb_export --id=x --enable_ntfs_acl=false
    :return:
    """
    ...
    create_file_path = nas_common.ROOT_DIR + "nas_16-0-4-48_dir"
    ...
    check_result2 = nas_common.create_smb_export(access_zone_id=access_zone_id,
                                                export_name="nas_16_0_4_48_smb_export_name",
