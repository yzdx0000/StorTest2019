...
def executing_case():
    """
        1、创建一个共享路径深度为255的smb共享；
        pscli --command=create_smb_export --access_zone_id=x --export_name=export1 --export_path=volume:/dir3/dir4/…/dir255（注：255含/mnt/volume/）
    :return:
    """
    ...
    file_path_base = nas_common.VOLUME_NAME + ":/"
        ...
        if i < 253:     # 循环253次（i=0~252），创建的目录都是合法的
            ...
            if i == 252:
                check_result3 = nas_common.create_smb_export(access_zone_id=access_zone_id,
                                                             export_name="nas_16_0_4_31_smb_export_name",
