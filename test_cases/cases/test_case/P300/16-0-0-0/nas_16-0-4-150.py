...
def executing_case():
    ...
    # create_ftp_export
    export_name = "nas_16_0_4_150_ftp_export_name"
    ...
    check_result4 = nas_common.delete_ftp_exports(ids=result)
    if check_result4["detail_err_msg"] != "":
        log.error(("%s Failed") % FILE_NAME)
        raise Exception(("%s Failed") % FILE_NAME)

    check_result5 = nas_common.get_ftp_exports()
