...
def executing_case():
    """
        1、创建授权ip为一个网段的smb共享；
        pscli --command=create_smb_export --access_zone_id=x --export_name=x --export_path=volume:/export --authorization_ip=1.1.1.0/24
    :return:
    """
    ...
    dir_name = "nas_16-0-4-44_dir"
    create_file_path = nas_common.ROOT_DIR + dir_name
    authorization_ip = "44.44.44.0/24"
    ...
    check_result2 = nas_common.create_smb_export(access_zone_id=access_zone_id,
                                                 export_name="nas_16_0_4_44_smb_export_name",
