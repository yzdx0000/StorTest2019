...
def executing_case():
    """
        1、创建一个允许匿名登录的FTP共享；
        pscli --command=create_ftp_export --access_zone_id=1 --export_name=ftp_export_name --export_path=volume:/export/dir --description=allow_anonymous --allow_anonymous=true
    :return:
    """
    ...
    export_name = "nas_16_0_4_143_ftp_export_name"
