...
# Date: 2018-08-24
# @summary：
#   正常连接AD认证服务器开启rfc2307映射
# @steps:
#   1、集群添加ad认证,填写正确的域名、dnsIP、管理员账户和管理员密码；
#   pscli --command=add_auth_provider_ad --name=ADtest --domain_name=xxx --dns_addresses=x.x.x.x
#   --username=adminstrator --password=xxx --services_for_unix=RFC2307 --rfc2307_unix_id_range=10001-20000
#   --other_unix_id_range=20001-30000
...
def executing_case():
    ...
    auth_provider_ad_name = "nas_16_0_0_14_ad_auth_name"
