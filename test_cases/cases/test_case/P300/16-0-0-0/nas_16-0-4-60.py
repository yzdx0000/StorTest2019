...
def executing_case():
    """
        1、关闭enable_change_notify；
        pscli --command=update_smb_global_config --id=x --enable_change_notify=false
    :return:
    """
