...
def executing_case():
    ...
    4、修改username；
    pscli --command=update_auth_provider_ad --id=x --username=new_administrator
    :return:
    """
    log.info("（2）executing_case")

    # for add_auth_provider_ad
    auth_provider_ad_name = "nas_16_0_7_4_ad_auth_name"
    ...
    # node_ids = "1,2,3"
    access_zone_name = "nas_16_0_7_4_access_zone_name"
