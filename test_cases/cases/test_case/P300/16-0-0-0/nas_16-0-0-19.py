...
def executing_case():
    """
        1、集群添加ad认证,填写正确的dnsIP、管理员账户和管理员密码；
        ...
        4、通过命令pscli --command=update_auth_provider_ad --id=x --name=ADtest1 修改名称；
    ...
    old_auth_provider_name = "nas_16_0_0_19_ad_auth_old_name"
    new_auth_provider_name = "nas_16_0_0_19_ad_auth_new_name"

    check_result1 = nas_common.add_auth_provider_ad(name=old_auth_provider_name,
    ...
    check_result4 = nas_common.update_auth_provider_ad(provider_id=result, name=new_auth_provider_name)
