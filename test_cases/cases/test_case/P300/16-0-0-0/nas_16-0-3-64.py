...
#   6、通过命令行修改vip地址池；
#   pscli --command=update_vip_address_pool --id=x --load_balance_policy=LB_CPU_USAGE
...
def executing_case():
    ...
    access_zone_name = 'nas_16_0_3_64_access_zone_name'
    # for create_subnet
    subnet_name = 'nas_16_0_3_64_subnet_name'
    ...
    load_balance_policy = nas_common.BALANCE_LB_CPU_USAGE
