...
def executing_case():
    """
        1、创建一个描述信息长度为1的smb共享；
        2、创建一个描述信息长度为255的smb共享；
        3、创建一个描述信息长度为256的smb共享；
    :return:
    """
    ...
    create_file_path_1 = nas_common.ROOT_DIR + "nas_16-0-4-34_dir_1"
    create_file_path_2 = nas_common.ROOT_DIR + "nas_16-0-4-34_dir_2"
    create_file_path_3 = nas_common.ROOT_DIR + "nas_16-0-4-34_dir_3"
    ...
    check_result = nas_common.create_smb_export(access_zone_id=access_zone_id,
                                                export_name="nas_16_0_4_34_smb_export_name_1",
    ...
    check_result = nas_common.create_smb_export(access_zone_id=access_zone_id,
                                                export_name="nas_16_0_4_34_smb_export_name_2",
    ...
    check_result = nas_common.create_smb_export(access_zone_id=access_zone_id,
                                                export_name="nas_16_0_4_34_smb_export_name_3",
                                                export_path=create_file_path_3,
                                                description=description_3)
    if check_result["detail_err_msg"].find("exceed the max length:255") == -1:
        log.error(("%s Failed") % FILE_NAME)
        raise Exception(("%s Failed") % FILE_NAME)
    else:
