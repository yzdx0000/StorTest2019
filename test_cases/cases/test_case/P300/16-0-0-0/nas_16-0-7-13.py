...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：16-0-x-x 修改user_search_path
...
def executing_case():
    ...
    4、修改user_search_path；
    pscli --command=update_auth_provider_ldap --id=x --user_search_path="ou=user1,dc=abc1,dc=com"
    pscli --command=update_auth_provider_ldap --id=x --user_search_path=
    pscli --command=update_auth_provider_ldap --id=x --user_search_path="ou=user2,dc=abc2,dc=com"
    :return:
    """
    log.info("（2）executing_case")

    # for add_auth_provider_ldap
    auth_provider_ldap_name = "nas_16_0_7_13_ldap_auth_name"
    ...
    # node_ids = "1,2,3"
    access_zone_name = "nas_16_0_7_13_access_zone_name"

    # for update_auth_provider_ldap
    new_user_search_path1 = "ou=user1,dc=abc1,dc=com"
    new_user_search_path2 = ""
    new_user_search_path3 = "ou=user2,dc=abc2,dc=com"
    ...
    check_result4 = nas_common.update_auth_provider_ldap(provider_id=auth_provider_id,
                                                         user_search_path=new_user_search_path1)
    ...
    check_result6 = nas_common.update_auth_provider_ldap(provider_id=auth_provider_id,
                                                         user_search_path=new_user_search_path2)
    ...
    check_result8 = nas_common.update_auth_provider_ldap(provider_id=auth_provider_id,
                                                         user_search_path=new_user_search_path3)
