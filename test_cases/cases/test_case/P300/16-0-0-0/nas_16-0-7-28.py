...
# Date: 2018-08-09
# @summary：
#   add_smb_export_auth_clients的name参数使用group name，type参数使用USER
# @steps:
...
#   2、add_smb_export_auth_clients指定name为存在的group name，type为USER，run_as_root为true；
#   pscli --command=add_smb_export_auth_clients --export_id=x --name=exist_group_name --type=USER --run_as_root=true
...
def executing_case():
    ...
    auth_provider_name = 'nas_16_0_7_28_ad_auth_name'
    ...
    unix_id_range = [9000, 9099]
    # for create_access_zone
    node_ids = '1,2,3'
    access_zone_name = 'nas_16_0_7_28_access_zone_name'
    # for create_file
    dir_name = 'nas_16-0-7-28_dir'
    ...
    export_name = 'nas_16_0_7_28_smb_export_name'
