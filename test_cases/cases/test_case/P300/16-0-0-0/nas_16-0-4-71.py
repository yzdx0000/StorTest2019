...
def executing_case():
    ...
    auth_provider_ad_name = "nas_16_0_4_71_ad_auth_name"
    unix_id_range_list = [11001,12000]
    # create_file
    create_file_path = nas_common.ROOT_DIR + "nas_16-0-4-71_dir"
    # create_smb_export
    export_name = "nas_16_0_4_71_smb_export_name"
    # add_smb_export_auth_clients
    smb_export_auth_clients_name_1 = "nas_16-0-4-71_user_1"
    smb_export_auth_clients_name_2 = "nas_16-0-4-71_group"
    ...
    ids = ','.join(str(i) for i in [result2,result3])
    check_result6 = nas_common.remove_smb_export_auth_clients(ids=ids)
