...
def executing_case():
    """
    1、增加AD鉴权服务器；
    pscli --command=add_auth_provider_ad --name=adname --domain_name=adtest.com --dns_addresses=10.2.40.251 --username=administrator --password=111111 --services_for_unix=NONE --unix_id_range=5000-6000
    ...
    4、update时使用check；
    pscli --command=update_auth_provider_ad --id=x --check=true（--可添加其他参数）
    :return:
    """
    log.info("（2）executing_case")

    # for add_auth_provider_ad
    auth_provider_ad_name = "nas_16_0_7_6_ad_auth_name"
    ...
    # node_ids = "1,2,3"
    access_zone_name = "nas_16_0_7_6_access_zone_name"

    # for update_auth_provider_ad
    new_name = "nas_16_0_7_6_ad_auth_new_name"
    new_domain_name = "new-domain-name.com"
    new_dns_addresses = "250.250.250.250"
    new_username = "new_administrator"
    ...
    check_result4 = nas_common.update_auth_provider_ad(provider_id=auth_provider_id,
                                                       ...
                                                       dns_addresses=new_dns_addresses,
