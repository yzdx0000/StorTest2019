...
def executing_case():
    """
        ...
        4、通过命令pscli --command=update_auth_provider_ad --id=x --dns_addresses=x.x.x.x 修改DNS地址；
    ...
    old_auth_provider_dns_addresses = "1.1.1.1"
    new_auth_provider_dns_addresses = nas_common.AD_DNS_ADDRESSES

    check_result1 = nas_common.add_auth_provider_ad(name="nas_16_0_0_21_ad_auth_name",
                                                    domain_name=nas_common.AD_DOMAIN_NAME,
                                                    dns_addresses=old_auth_provider_dns_addresses,
    ...
    if cmp(auth_provider, {
            ...
            "id": int("%s" % result),
            "key": int("%s" % result),
            "name": "nas_16_0_0_21_ad_auth_name",
            "other_unix_id_range": [
                2147483646,
                2147483647
            ],
    ...
    check_result4 = nas_common.update_auth_provider_ad(provider_id=result,
                                                       dns_addresses=new_auth_provider_dns_addresses)
