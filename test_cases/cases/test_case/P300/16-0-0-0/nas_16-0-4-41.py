...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：16-0-x-x 打开alternative_atasource
#######################################################
...
def executing_case():
    """
        1、创建一个开启enable_alternative_datasource的smb共享；
        pscli --command=create_smb_export --access_zone_id=1 --export_name=smb_2 --export_path=parastor:/smb_2/ --enable_alternative_datasource=true
    ...
    check_result2 = nas_common.create_smb_export(access_zone_id=access_zone_id,
                                                 export_name="nas_16_0_4_41_smb_export_name",
