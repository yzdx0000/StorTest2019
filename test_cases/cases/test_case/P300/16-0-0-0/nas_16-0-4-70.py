...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：16-0-x-x AD用户/用户组默认自带SMB权限
#######################################################
...
def executing_case():
    ...
    auth_provider_ad_name = "nas_16_0_4_70_ad_auth_name"
    unix_id_range_list = [12001,13000]
    # create_file
    create_file_path = nas_common.ROOT_DIR + "nas_16-0-4-70_dir"
    # create_smb_export
    export_name = "nas_16_0_4_70_smb_export_name"
    # add_smb_export_auth_clients
    smb_export_auth_clients_name_1 = "nas_16-0-4-70_user"
    smb_export_auth_clients_name_2 = "nas_16-0-4-70_group"
