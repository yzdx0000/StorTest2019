...
def executing_case():
    ...
    4、修改bind_password；
    pscli --command=update_auth_provider_ldap --id=x --bind_password=new_111111
    pscli --command=update_auth_provider_ldap --id=x --bind_password=
    pscli --command=update_auth_provider_ldap --id=x --bind_password=new_111111_2
    :return:
    """
    log.info("（2）executing_case")

    # for add_auth_provider_ldap
    auth_provider_ldap_name = "nas_16_0_7_12_ldap_auth_name"
    ...
    # node_ids = "1,2,3"
    access_zone_name = "nas_16_0_7_12_access_zone_name"

    # for update_auth_provider_ldap
    new_bind_password1 = "new_111111"
    new_bind_password2 = ""
    new_bind_password3 = "new_111111_2"
    ...
    check_result4 = nas_common.update_auth_provider_ldap(provider_id=auth_provider_id,
                                                         bind_password=new_bind_password1)
    ...
    check_result6 = nas_common.update_auth_provider_ldap(provider_id=auth_provider_id,
                                                         bind_password=new_bind_password2)
    ...
    check_result8 = nas_common.update_auth_provider_ldap(provider_id=auth_provider_id,
                                                         bind_password=new_bind_password3)
