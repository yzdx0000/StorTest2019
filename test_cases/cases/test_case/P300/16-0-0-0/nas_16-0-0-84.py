...
def executing_case():
    ...
    check_result1 = nas_common.add_auth_provider_nis(name="nas_16_0_0_84_nis_auth_name",
    ...
    if cmp(auth_provider, {
                ...
                "key": int("%s" % result),
                "name": "nas_16_0_0_84_nis_auth_name",
                "type": "NIS",
                "version": 0
            }):
        log.error(("%s Failed") % FILE_NAME)
    ...
    check_result4 = nas_common.delete_auth_providers(ids=result)
