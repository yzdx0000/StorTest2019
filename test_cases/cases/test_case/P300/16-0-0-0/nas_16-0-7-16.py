...
def executing_case():
    ...
    4、修改name；
    pscli --command=update_auth_provider_nis --id=x --name=new_name
    :return:
    """
    log.info("（2）executing_case")

    # for add_auth_provider_nis
    auth_provider_nis_name = 'nas_16_0_7_16_nis_auth_name'
    ...
    # node_ids = "1,2,3"
    access_zone_name = 'nas_16_0_7_16_access_zone_name'

    # for update_auth_provider_nis
    new_name = 'nas_16_0_7_16_nis_auth_new_name'
