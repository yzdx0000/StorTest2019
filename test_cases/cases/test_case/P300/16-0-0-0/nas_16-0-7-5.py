...
def executing_case():
    ...
    4、修改password；
    pscli --command=update_auth_provider_ad --id=x --password=new_password
    :return:
    """
    log.info("（2）executing_case")

    # for add_auth_provider_ad
    auth_provider_ad_name = "nas_16_0_7_5_ad_auth_name"
    ...
    # node_ids = "1,2,3"
    access_zone_name = "nas_16_0_7_5_access_zone_name"
