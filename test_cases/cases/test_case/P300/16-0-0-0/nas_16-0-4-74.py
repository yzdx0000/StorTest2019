...
def executing_case():
    ...
    # create_file
    create_file_path = nas_common.ROOT_DIR + "nas_16-0-4-74_dir"
    # create_smb_export
    export_name = "nas_16_0_4_74_smb_export_name"
    # add_smb_export_auth_clients
    smb_export_auth_clients_name_1 = "nas_16-0-4-74_user_1"
    smb_export_auth_clients_name_2 = "nas_16-0-4-74_group"
    ...
    check_result7 = nas_common.remove_smb_export_auth_clients(ids=ids)
