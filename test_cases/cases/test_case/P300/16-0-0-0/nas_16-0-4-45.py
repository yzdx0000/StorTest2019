...
def executing_case():
    """
        1、创建授权ip为一个网段除去某些ip的smb共享；
        pscli --command=create_smb_export --access_zone_id=x --export_name=x --export_path=volume:/export --authorization_ip=1.1.1.0/24 EXCEPT 1.1.1.2,1.1.1.3
    :return:
    """
    ...
    dir_name = "nas_16-0-4-45_dir"
    create_file_path = nas_common.ROOT_DIR + dir_name
    authorization_ip = "45.45.45. EXCEPT 45.45.45.2 45.45.45.3"
    ...
    check_result2 = nas_common.create_smb_export(access_zone_id=access_zone_id,
                                                 export_name="nas_16_0_4_45_smb_export_name",
