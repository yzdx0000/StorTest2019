...
def executing_case():
    ...
    create_file_path = nas_common.ROOT_DIR + "nas_16-0-4-56_dir"
    export_name = "nas_16_0_4_56_smb_export_name"
    ...
    check_result4 = nas_common.delete_smb_exports(ids=result)
