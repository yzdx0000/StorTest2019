...
def executing_case():
    """
        1、修改smb共享的enable_oplocks配置；
        pscli --command=update_smb_export --id=x --enable_oplocks=false
        pscli --command=update_smb_export --id=x --enable_oplocks=true
    :return:
    """
    ...
    create_file_path = nas_common.ROOT_DIR + "nas_16-0-4-53_dir"
    export_name = "nas_16_0_4_53_smb_export_name"
