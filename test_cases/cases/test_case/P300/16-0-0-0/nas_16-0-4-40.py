...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：16-0-x-x 关闭dos_attributes
#######################################################
...
def executing_case():
    """
        1、创建一个关闭enable_dos_attributes的smb共享；
        pscli --command=create_smb_export --access_zone_id=1 --export_name=smb_2 --export_path=parastor:/smb_2/ --enable_dos_attributes=false
    ...
    check_result2 = nas_common.create_smb_export(access_zone_id=access_zone_id,
                                                 export_name="nas_16_0_4_40_smb_export_name",
