...
def executing_case():
    ...
    4、修改name；
    pscli --command=update_auth_provider_ldap --id=x --name=new_name
    :return:
    """
    log.info("（2）executing_case")

    # for add_auth_provider_ldap
    auth_provider_ldap_name = "nas_16_0_7_7_ldap_auth_name"
    ...
    # node_ids = "1,2,3"
    access_zone_name = "nas_16_0_7_7_access_zone_name"

    # for update_auth_provider_ldap
    new_name = "nas_16_0_7_7_ldap_auth_new_name"
