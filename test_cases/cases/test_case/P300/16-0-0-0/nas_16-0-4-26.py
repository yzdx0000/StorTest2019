...
def executing_case():
    """
        1、创建/export目录的smb共享；
        pscli --command=create_smb_export --access_zone_id=x --export_name=export1 --export_path=volume:/export
        2、创建/export/dir目录的smb共享；
        pscli --command=create_smb_export --access_zone_id=x --export_name=export1 --export_path=volume:/export/dir
    :return:
    """
    ...
    check_result3 = nas_common.create_smb_export(access_zone_id=access_zone_id,
                                                 export_name="nas_16_0_4_26_smb_export_name_1",
    ...
    check_result4 = nas_common.get_smb_exports(ids=result1)
    ...
    check_result5 = nas_common.create_smb_export(access_zone_id=access_zone_id,
                                                 export_name="nas_16_0_4_26_smb_export_name_2",
    ...
    check_result6 = nas_common.get_smb_exports(ids=result2)
...
class Nas_Class_16_0_4_26():
    def nas_method_16_0_4_26(self):
        nas_main()
