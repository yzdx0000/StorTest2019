...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：16-0-x-x 修改alternative_data_sourece配置
#######################################################
...
def executing_case():
    """
        1、修改smb共享的enable_alternative_datasource配置；
        pscli --command=update_smb_export --id=x --enable_alternative_datasource=true
        pscli --command=update_smb_export --id=x --enable_alternative_datasource=false
    :return:
    """
    ...
    create_file_path = nas_common.ROOT_DIR + "nas_16-0-4-50_dir"
    export_name = "nas_16_0_4_50_smb_export_name"
