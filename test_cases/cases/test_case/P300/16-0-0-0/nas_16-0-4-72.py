...
def executing_case():
    ...
    auth_provider_ad_name = "nas_16_0_4_72_ad_auth_name"
    unix_id_range_list = [12001,13000]
    # create_file
    create_file_path = nas_common.ROOT_DIR + "nas_16-0-4-72_dir"
    # create_smb_export
    export_name = "nas_16_0_4_72_smb_export_name"
    # add_smb_export_auth_clients
    smb_export_auth_clients_name_1 = "nas_16-0-4-72_user_1"
    smb_export_auth_clients_name_2 = "nas_16-0-4-72_group"
    ...
    check_result6 = nas_common.update_smb_export_auth_client(auth_client_id=result2,
                                                             run_as_root="false",
                                                             permission_level="rw")
    ...
    check_result7 = nas_common.update_smb_export_auth_client(auth_client_id=result3,
                                                             run_as_root="false",
                                                             permission_level="ro")
    ...
    check_result8 = nas_common.get_smb_export_auth_clients(export_ids=result1)
    smb_export_auth_clients = check_result8["result"]["smb_export_auth_clients"]
