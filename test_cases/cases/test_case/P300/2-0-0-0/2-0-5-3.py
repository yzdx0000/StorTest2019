...
def up_down():
    ...
    time.sleep(120)
    log.info("\033[1;31;40m在业务运行过程中，将非lmos日志节点A数据网断开；\033[0m")
    args = this.get_lmos_node_ip_and_eth(is_lmos=False)
