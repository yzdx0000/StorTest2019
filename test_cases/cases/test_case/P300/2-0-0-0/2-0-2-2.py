...
def up_down():
    ...
    while True:
        ...
        if 'down' in line:
            break
    time.sleep(60)
    log.info("\033[1;31;40m在业务运行过程中，将一带lmos日志角色节点关机；\033[0m")
    ip_lst = []
    ...
    data_lst = this.down_node(ip_lst)
    while True:
        line = os.read(read_file, 32)
        if 'up' in line:
            break
