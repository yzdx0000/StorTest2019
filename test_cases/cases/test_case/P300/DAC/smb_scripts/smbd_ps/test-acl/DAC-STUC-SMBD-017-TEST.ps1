...
get-Content -Path $file_path > $xmlpath\..\tmp
$result_2=$?
if ($result_2)
{    
    echo "$st_case test success"
...
#整个testcase是否成功
if($result_1  -and $result_2 -and $result_3 -and $result_xattr)
{    
