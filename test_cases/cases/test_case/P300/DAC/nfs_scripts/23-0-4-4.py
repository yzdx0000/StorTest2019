...
# date 2018-11-19
# @summary：
#    nfs客户端权限测试：u2属于多个组，检测文件权限；原P200测试用例23-0-4-4。
# @steps:
...
def case():
    ...
    log.info("6> 测试主体：%s属于多个组，测试文件权限" % user_name_list[1])
