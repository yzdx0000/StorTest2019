...
def case():
    lun_size = int((1.2 * storage_pool_size) / float(cp("reserve", "multiple")))
    log.info(lun_size)
    msg = osan.create_lun(s_ip=node_ip1, total_bytes=lun_size, lun_type="THICK",
                          lun_name='LUN1',
    ...
    lun_size = int(storage_pool_size / float(cp("reserve", "multiple")))
    log.info(lun_size)
    lun_id = osan.create_lun(s_ip=node_ip1, total_bytes=lun_size, lun_type="THICK",
                             lun_name='LUN2',
