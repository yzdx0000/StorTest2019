...
def iscsi_login():
    ...
    mix_R_Align = env_manage_repair_test.co2_osan.gen_vdb_xml(max_range=None,
                                                              maxdata="900M",                                                              thread=cp("vdbench", "threads"), lun=lun1,
...
def re_scan():
    ...
    env_manage_lun_manage.assert_ins.assertEqual(2147483648, lun_size2)
