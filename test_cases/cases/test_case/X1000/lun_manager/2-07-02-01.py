...
def iscsi_login():
    ...
    min_seq_w1 = env_manage_lun_manage.co2_osan.gen_vdb_xml(max_range="200M",
                                                            thread=cp("vdbench", "threads"), lun=lun1,
                                                            xfersize=xfersize1, seekpct=seekpct, rdpct=rdpct1)
    min_seq_w2 = env_manage_lun_manage.co2_osan.gen_vdb_xml(max_range="100M", maxdata=thin_lun_maxdata,
