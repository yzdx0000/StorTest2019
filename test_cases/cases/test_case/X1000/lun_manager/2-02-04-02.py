...
def case():
    msg = osan.create_lun(s_ip=deploy_ips[0], total_bytes='102400000', lun_type="THICK",
                          lun_name='LUN1',
                          stor_pool_id=2, acc_zone_id=1, stripe_width=8, disk_parity_num=0, node_parity_num=2)
    log.error(msg)
