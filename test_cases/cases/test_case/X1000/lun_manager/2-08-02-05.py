...
def lun_map1(arg=1):
    ...
    exe_id1 = env_manage_lun_manage.Reliable_osan.get_node_id_by_ip(node_ip1)

    targets1 = env_manage_lun_manage.osan.gen_dict_mul(s_ip=node_ip1, command="get_targets", arg1="nodeId",
                                                      arg2="id",
                                                      arg3="targets", target=exe_id1)

    exe_id2 = env_manage_lun_manage.Reliable_osan.get_node_id_by_ip(node_ip2)

    targets2 = env_manage_lun_manage.osan.gen_dict_mul(s_ip=node_ip2, command="get_targets", arg1="nodeId",
                                                      arg2="id",
                                                      arg3="targets", target=exe_id2)
    ...
    luns2 = env_manage_lun_manage.osan.get_luns_by_node_id(node_id=node_id2)
    ...
    for lun in luns1:
        env_manage_lun_manage.osan.lun_map_by_target(node_ip1, lun_ids=lun, target_id=targets1[0], hp_id=hg_id)
    for lun in luns2:
        env_manage_lun_manage.osan.lun_map_by_target(node_ip1, lun_ids=lun, target_id=targets1[0], hp_id=hg_id)
    for lun in luns3:
