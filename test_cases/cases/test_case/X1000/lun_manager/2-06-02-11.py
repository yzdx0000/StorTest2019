...
def case():
    ...
    node_pool_id = osan.create_node_pool(s_ip=node_ip1, node_ids=node_ids_list[0],
                                         replica_num=1,
                                         stripe_width=1,
                                         disk_parity_num=0,
                                         node_parity_num=0,
    ...
    osan.update_node_pool(s_ip=node_ip1, node_ids=node_ids, name="nodepool1",
...
def main():
    ...
    case()  # 用例步骤
    env_manage_lun_manage.init_env()
