...
4、在步骤3中的业务运行过程中，将节点A下电，free日志节点D接管节点A的日志时，oRole主故障；
5、数据修复过程中在主机1上执行vdbench -f mix-S-Align.conf -jro比较一致性；
6、节点A上电恢复，数据修复完成后，比较存储内部数据一致性。
:Changerlog:
"""
# testlink case: 1000-32555
import os,sys
import commands
import threading
import random
