...
def up_down():
    log.info("故障点:一个非日志节点的单个网线闪断")
    time.sleep(100)
    log.info("Step4:在步骤3中的业务运行过程中，将节点的一根数据网闪断,节点%s,网卡:%s." %(fault_node_ip, fault_eth_name))
    reliable.net_flash_test(fault_node_ip, fault_eth_name)
def vdb_jn():
