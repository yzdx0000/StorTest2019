...
:Description:
            ...
            4、在步骤3中的业务运行过程中，将节点A的oPmgr进程异常后再将节点B上的oStor进程异常；
            5、检查节点A oPmgr，和节点BoStor进程
            6、主机1上业务完成后，在主机1上执行vdbench -f mix-R.conf -jro比较一致性；
            7、比较存储内部数据一致性。
:Changerlog:
"""
