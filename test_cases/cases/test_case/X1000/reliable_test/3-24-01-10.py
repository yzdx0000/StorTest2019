...
#disk_id = disk.get_diskid_by_name(s_ip=fault_ip,node_id=node_id,disk_name=fault_disk)
#disk_uuid = disk.get_disk_uuid_by_name(s_ip=fault_ip,node_id=node_id,disk_name=fault_disk)
...
#        disk_id = disk.get_diskid_by_name(s_ip=fault_ip, node_id=node_id, disk_name=disk)
#        disk_uuid = disk.get_disk_uuid_by_name(s_ip=fault_ip, node_id=node_id, disk_name=disk)
