...
error.rel_check_before_run(file_name, jnl_rep=4, node_num=5, free_jnl_num=0, data_rep=4)
...
use_jnl_ips.remove(fault_node_c_ip)
fault_node_d_ip = random.choice(use_jnl_ips)
def up_down(pipeout):
    time.sleep(100)
    ...
    common.check_ip(fault_node_c_ip)
