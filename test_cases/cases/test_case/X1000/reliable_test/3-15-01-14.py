...
def up_down():
    ...
    log.info("Step4:修改等待超时时间，触发非业务日志节点A超时重建,节点:%s" % free_jnl_ip)
    reliable.run_down_node_wait(free_jnl_ip, '300000')
    time.sleep(100)
    ...
    breakdown.run_down_node_wait(free_jnl_ip, '86400000')
