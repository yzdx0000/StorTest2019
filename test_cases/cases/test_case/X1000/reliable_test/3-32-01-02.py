...
log.info("Got machine A's IP: %s, dev name is %s, extra IP is %s, and machine B's IP: %s." % (a_ip, a_eths, a_extra, b_ip))
...
def up_down(pipein):
    ...
    log.info("On node %s kill oStor and rename it." % (b_ip,))
    cmd = ("ssh root@%s 'mv /home/parastor/bin/oStor /home/parastor/bin/oStor.bak'" % (b_ip,))
