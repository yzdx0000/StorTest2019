...
#print strip
for i in range(0,8):
    osan.create_lun(s_ip=deploy_ips[0],lun_name="lun_"+str(i),stor_pool_id=storid[1],acc_zone_id=acc_zone_ids,replica_num="3")
...
for sip in deploy_ips:
    cmd = ("ssh %s \"mkdir -p /home/parastor/log/otrace/;touch /home/parastor/log/otrace/otrace.data;/home/parastor/tools/otrc -o /home/parastor/log/otrace/otrace.data -s 4096 -S \"IOPREP|DJNL|DPC|LMPC|LIOC\";/home/parastor/tools/otrc -z on\""
           %(sip))
    (res, final) = commands.getstatusoutput(cmd)
    if res != 0:
        print "Open otrace faild."
        exit(1)
