...
def os_error(arg=3):
    ...
    ReliableTest.run_kill_process(node_ip1, "oPara")  # 将源节点oPara进程故障
...
def case():
    ...
    iscsi_login()
    log.info(
        "step2:在主机1上运行vdbench -f mix-R-Align.conf -jn；在主机2上运行vdbench -f mix-R.conf,业务过程中，业务过程中将存一节点掉电 ...")
