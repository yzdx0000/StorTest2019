...
# Date  :2018-8-7
"""
测试内容:副本下，数据修复过程中，修复过程中将目标节点数据网闪断10秒
步骤:
...
def case():
    ...
    log.info("step3:插回被拔出的磁盘触发修复，修复过程中将目标节点数据网闪断10秒,主机端执行vdbench -f mix-R-Align.conf -jro;校验数据一致性 ...")
