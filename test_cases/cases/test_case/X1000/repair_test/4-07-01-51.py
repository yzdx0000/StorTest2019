...
7、恢复故障的目标盘，数据重建和修复完成后，比较内部元数据一致性。
...
def case():
    ...
    env_manage_repair_test.Reliable_osan.insert_disk(node_ip=node_ip2, disk_id=disk_phy_id3, disk_usage="SHARED")
