...
def up_down():
    time.sleep(150)
    log.info("Step6:数据重建过程中,将该重建目标节点数据网闪断,节点:%s" % (fault_node_ip))
    reliable.net_flash_test(fault_node_ip, fault_eth_list)
