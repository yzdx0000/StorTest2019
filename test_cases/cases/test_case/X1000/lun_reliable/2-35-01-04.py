...
def case():
    ...
    if nums == len(lun_ids):
        ...
        env_manage.up_network(test_node_ip, subnet_eth)
    else:
        env_manage.up_network(test_node_ip, subnet_eth)
