...
#offset = "8192"
#align = "3072"
xfersize1 = "(16k,20,32k,10,64k,30,192k,40),unmappct=20"
xfersize2 = "(270k,20,520k,10,1020k,30,4095k,40),unmappct=20"
...
for i in range(0,len(lun)):
    ...
    if i % 2 == 0:
        ...
        vdb_xml = osan.vdb_write(sd="sd"+str(j),lun=lun[i],wd="wd"+str(j),xfersize=xfersize2,seekpct=seekpct,rdpct=rdpct)
#生成vdbench测试用的配置文件
