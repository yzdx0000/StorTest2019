...
#offset = "8192"
align = "3072"
xfersize1 = "(240k,20,390k,10,1036k,30,4090k,40),unmappct=20"
#xfersize2 = "(240k,20,390k,10,1536k,30,8192k,40),unmappct=20"
...
for i in range(0,len(lun)):
    ...
    if i % 2 == 0:
        ...
        vdb_xml = osan.vdb_write(sd="sd"+str(j),lun=lun[i],wd="wd"+str(j),align=align,xfersize=xfersize1,seekpct=seekpct,rdpct=rdpct)
#生成vdbench测试用的配置文件
