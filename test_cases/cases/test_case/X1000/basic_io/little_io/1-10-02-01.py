...
#offset = "8192"
align = "3072"
xfersize1 = "(256k,20,512k,10,1028k,30,2096k,40)"
xfersize2 = "(256k,20,512k,10,1028k,30,2096k,40)"
...
osan.vdb_write(sd="sd1",lun=lun[0],wd="wd1",xfersize=xfersize1,seekpct=seekpct,rdpct=rdpct)
vdb_xml = osan.vdb_write(sd="sd2",lun=lun[1],wd="wd2",align=align,xfersize=xfersize2,seekpct=seekpct,rdpct=rdpct)
#生成vdbench测试用的配置文件
