...
offset = "8192"
align = "3072"
xfersize = "(256k,20,512k,10,1024k,30,4096k,40),unmappct=20"
#生成vdbench测试用的配置文件
#模板：vdb_xml = osan.gen_vdb_xml(lun=lun, xfersize=xfersize, align=align, offset=offset, rdpct=rdpct, seekpct=seekpct)
vdb_xml = osan.gen_vdb_xml(lun=lun, xfersize=xfersize, offset=offset, align=align, rdpct=rdpct, seekpct=seekpct)
print vdb_xml
#运行vdbench
#jn_jro = "no"
