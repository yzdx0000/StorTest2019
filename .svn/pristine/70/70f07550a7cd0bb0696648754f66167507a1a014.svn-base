...
def case():
    ...
    typical_event_code = '0x02040001'   # 创建节点池成功对应的编号
    if typical_event_code in event_codes:
        log.info('creating node_pool displayed correct !!!')
    else:
        log.error('creating node_pool displayed wrong !!!')
        raise Exception('creating node_pool displayed wrong !!!')
