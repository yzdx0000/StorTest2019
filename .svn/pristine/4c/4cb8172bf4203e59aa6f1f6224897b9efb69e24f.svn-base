...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：11-0-1-14 目录逻辑空间配额混合阈值，软阈值最小
#######################################################
...
def executing_case():
    ...
    if check_result["err_no"] == 0:
        ...
        log.error("11-0-1-14 Failed")
        raise Exception("11-0-1-14 Failed")
    else:
        log.info("11-0-1-14 Succeed")
    return
...
class Quota_Class_11_0_1_14():
    def quota_method_11_0_1_14(self):
