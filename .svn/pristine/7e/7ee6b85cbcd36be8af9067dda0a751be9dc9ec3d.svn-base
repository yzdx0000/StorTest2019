...
def case():
    ...
    if "200 OK" in opt1 and "200 OK" in opt2 and "200 OK" in opt_l1[0] and "403" in opt_l1[1] and "200 OK" in \
            opt_l2[0] and "200 OK" in opt_l2[1] and "200 OK" in opt_l2[2] and "403" in opt_l2[3]:
        pass
    else:
