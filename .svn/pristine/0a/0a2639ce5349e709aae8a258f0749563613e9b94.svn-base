...
def up_down():
    log.info("故障点:一个非日志节点的两根数据网先后故障后,该节点的主oRole进程故障")
    time.sleep(100)
    ...
    time.sleep(30)
    log.info("Step5:数据网故障上报后,随即将主oRole杀死,节点:%s" % non_jnl_ip)
    ...
    log.info("Step6:检查故障节点的oRole进程状态,节点:%s" % m_oRole_ip)
