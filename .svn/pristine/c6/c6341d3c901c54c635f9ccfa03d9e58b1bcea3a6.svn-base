...
file_path = nas_common.ROOT_DIR + FILE_NAME                     # parastor:/nas/events_5_3_3_79
...
def case():
    ...
    if check_result["detail_err_msg"] != "":
        common.except_exit("delete_file failed!!")
    '''2> 执行get_events查看结果显示'''
    delay_time = event_common.DELAY_TIME
    log.info('waiting for %s' % delay_time)
    time.sleep(delay_time)               # 删除目录成功，延时
    code = '0x02031205'                # 删除目录成功对应编号
