...
# date 2018-04-16
# @summary：
#    快照revert的时候，删除共享盘，观察revert数据的正确性
# @steps:
#    1、部署3节点集群，配比4 2 1；
...
#    5、删除一个节点的一块共享盘，删除过程中对快照a1进行revert；
...
SNAP_TRUE_PATH = os.path.join(snap_common.SNAP_PATH, FILE_NAME)              #/mnt/liyao/snap/snap_13_1_2_21
CREATE_SNAP_PATH = os.path.join(snap_common.SNAP_PATH_BASENAME, FILE_NAME)   #/snap/snap_13_1_2_21
