...
def case():
    ...
    az_id2 = osan.create_access_zone(s_ip=deploy_ips[0], node_id=node_ids_list[1], name='accesszonetest2')
    az_id3 = osan.create_access_zone(s_ip=deploy_ips[0], node_id=node_ids_list[2], name='accesszonetest3')
    env_manage_lun_manage.osan.enable_san(node_ip1,az_id1)
    env_manage_lun_manage.osan.enable_san(node_ip1, az_id2)
    env_manage_lun_manage.osan.enable_san(node_ip1, az_id3)
