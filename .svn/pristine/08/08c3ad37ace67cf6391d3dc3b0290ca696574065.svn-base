...
def executing_case():
    ...
    4、修改port；
    pscli --command=update_auth_provider_ldap --id=x --port=250
    :return:
    """
    log.info("（2）executing_case")

    # for add_auth_provider_ldap
    auth_provider_ldap_name = "nas_16_0_7_10_ldap_auth_name"
    ...
    # node_ids = "1,2,3"
    access_zone_name = "nas_16_0_7_10_access_zone_name"
