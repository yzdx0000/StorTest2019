...
def case(reboot=0):
    ...
    xm1_file3 = error.modify_deploy_xml(dst_ip=deploy_ips[2], ssd='false')

    new_node_id1 = env_manage_lun_manage.osan.add_nodes(node_ip1, xm1_file2)
    new_node_id2 = env_manage_lun_manage.osan.add_nodes(node_ip1, xm1_file3)
    ...
    osan.delete_node_pools(s_ip=node_ip2, node_pool_id=3)
