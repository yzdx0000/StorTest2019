...
def up_down():
    ...
    time.sleep(120)
    log.info("\033[1;31;40m在业务运行过程中，将从oRole的数据网断开；\033[0m")
    args = this.get_process_node_ip_and_eth("oRole", is_master=False)
