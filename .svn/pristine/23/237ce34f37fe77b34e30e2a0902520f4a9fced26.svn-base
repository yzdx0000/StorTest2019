...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：16-0-x-x 开启home目录，NTFS ACL 打开
#######################################################
...
def executing_case():
    """
        1、设置home目录后，再打开enable_ntfs_acl参数；
        pscli --command=update_smb_global_config --id=1 --home_dir="parastor:/homes" --enable_ntfs_acl=true
    :return:
    """
    ...
    create_file_path = nas_common.ROOT_DIR + "homes-nas_16-0-4-66_dir"
