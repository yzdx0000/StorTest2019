...
def case():
    ...
    for i in range(1, 101):
        common.rm_exe(quota_common.CLIENT_IP_2, os.path.join(quota_common.QUOTA_PATH, 'file_%d' % i))
    ...
    '''创建100个1m文件'''
    quota_common.creating_files(quota_common.CLIENT_IP_2, quota_common.QUOTA_PATH, 100, 1, "a")
