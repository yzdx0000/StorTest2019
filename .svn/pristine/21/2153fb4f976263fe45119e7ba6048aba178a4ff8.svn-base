...
def up_down():
    log.info("故障点:一个非日志节点的数据网单网线故障后,该节点立即掉电")
    time.sleep(100)
    log.info("Step4:业务过程中,先将非日志节点的单根数据网络断开,节点:%s" % non_jnl_ip)
    reliable.network_test(non_jnl_ip, fault_eth_name, 'down')
    time.sleep(30)
