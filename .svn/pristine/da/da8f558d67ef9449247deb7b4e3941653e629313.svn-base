...
log.info("Got machine B's info: fault ip is : %s,extra ip is %s,device name is :%s" % (a_ip, a_extra, a_eths))
a_eth = []
...
def up_down(pipein):
    time.sleep(10)
    log.info("4、在步骤3中的业务运行过程中，将日志节点B一个业务网线断开；")
