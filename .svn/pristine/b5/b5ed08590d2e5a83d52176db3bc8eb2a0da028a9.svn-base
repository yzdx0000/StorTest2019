...
osan.vdb_write(sd="sd1",lun=lun[0],wd="wd1",xfersize=xfersize1,rdpct=rdpct)
vdb_xml = osan.vdb_write(sd="sd2",lun=lun[1],wd="wd2",align=align,xfersize=xfersize2,rdpct=rdpct)
#生成vdbench测试用的配置文件
