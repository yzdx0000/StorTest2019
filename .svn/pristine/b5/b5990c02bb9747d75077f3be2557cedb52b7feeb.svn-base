...
def executing_case():
    ...
    # create_file
    dir_name = "nas_16-0-4-130_dir"
    create_file_path = nas_common.ROOT_DIR + dir_name
    # create_ftp_export
    export_name = "nas_16_0_4_130_ftp_export_name"
    ...
    check_result3 = nas_common.get_ftp_exports(ids=result1)
