...
def executing_case():
    ...
    # create_file
    create_file_path = nas_common.ROOT_DIR + "nas_16-0-4-78_dir"
    # create_smb_export
    export_name = "nas_16_0_4_78_smb_export_name"
    # add_smb_export_auth_clients
    smb_export_auth_clients_name_1 = "nas_16-0-4-78_user_1"
    smb_export_auth_clients_name_2 = "nas_16-0-4-78_group"
