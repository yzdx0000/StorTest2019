...
def executing_case():
    ...
    4、修改domain_name；
    pscli --command=update_auth_provider_nis --id=x --domain_name=new-nistest
    :return:
    """
    log.info("（2）executing_case")

    # for add_auth_provider_nis
    auth_provider_nis_name = 'nas_16_0_7_17_nis_auth_name'
    ...
    # node_ids = "1,2,3"
    access_zone_name = 'nas_16_0_7_17_access_zone_name'

    # for update_auth_provider_nis
    new_domain_name = 'new-nistest'
