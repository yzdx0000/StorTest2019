...
3、X个主机运行vdbench -f max-seq-write.conf -jn elapsed=24x3600）
4、rd中设置IO速率iorate=（1.2max,3600,max,3600,0.8max,3600,0.6max,3600,0.4max,3600）,distribution=variable；"
...
iorate_conf = ('iorate=(%s,3600,%s,3600,%s,3600,%s,3600,%s,3600)'
               % (int(iorate*1.2), int(iorate), int(iorate*0.8), int(iorate*0.6), int(iorate*0.4)))
