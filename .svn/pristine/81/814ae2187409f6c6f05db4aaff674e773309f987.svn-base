...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：11-0-1-72_su 目录用户组逻辑空间配额建议阈值之su方式
#######################################################
...
def executing_case():
    ...
    if total_file_size != quota_common.FILE_SIZE_3G:
        ...
        log.error("11-0-1-72_su Failed")
        raise Exception("11-0-1-72_su Failed")
    else:
        log.info("11-0-1-72_su Succeed")
    return
...
class Quota_Class_11_0_1_72_su():
    def quota_method_11_0_1_72_su(self):
