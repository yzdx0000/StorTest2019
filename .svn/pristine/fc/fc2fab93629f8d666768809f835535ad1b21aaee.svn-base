...
def executing_case():
    """
        1、创建一个共享名以字母开头的含数字和下划线的长度超过80位的FTP共享；
        2、创建一个共享名以字母开头的，除了含数字和下划线还含有其他字符的FTP共享（用户名长度在1-80之间）；
    :return:
    """
    ...
    # export_name边界值检查
    illegal_name = "nas_16_0_4_133_export_name0000000000000000000000000000000000000000000000000000081"
    legal_name = "nas_16_0_4_133_export_name000000000000000000000000000000000000000000000000000080"

    dir_name = "nas_16-0-4-133_dir"
