...
master_ojmgs_id, master_ojmgs_ip = reliable.oJmgs_master_id()
...
def up_down(pipein):
    ...
    log.info("4、将%s oJmg故障；" % (master_ojmgs_ip,))
    ReliableTest.run_kill_process(master_ojmgs_ip, 'oJmgs')
    while True:
