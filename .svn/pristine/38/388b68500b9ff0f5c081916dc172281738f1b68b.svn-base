...
NAS_TRUE_PATH = os.path.join(nas_common.NAS_PATH, FILE_NAME)             # /mnt/volume/nas_test_dir/nas_16_6_0_18
...
def case():
    ...
    nas_common.create_nfs_export(access_zone_id, export_name, create_export_path)
    if exe_info["err_msg"] != "" or exe_info["detail_err_msg"] != "":
