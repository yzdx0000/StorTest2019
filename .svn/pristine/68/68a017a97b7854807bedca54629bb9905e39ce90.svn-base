...
3、X个主机运行大块顺序读（elapsed=24x3600）;
4、rd中设置IO速率iorate=（0.1max,1200,0.3max,600,0.5max,300,1.1max,120,0.3max,120）,distribution=variable；
...
iorate_conf = ('iorate=(%s,1200,%s,600,%s,300,%s,120,%s,50)'
               % (int(iorate*0.1), int(iorate*0.3), int(iorate*0.5), int(iorate*1.2), int(iorate*0.3)))
