...
def case():
    ...
    nas_common.create_auth_user(auth_provider_id=auth_provider_local_id,
    ...
    time.sleep(delay_time)               # 创建本地用户失败，延时
    code = '0x02030502'                # 创建本地用户失败对应编号
    description = 'create_auth_user'
