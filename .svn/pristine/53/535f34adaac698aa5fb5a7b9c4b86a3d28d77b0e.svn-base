...
offset = "8192"
align = "3072"
xfersize = "(16k,20,32k,10,64k,30,192k,40),unmappct=20"
#生成vdbench测试用的配置文件
#模板：vdb_xml = osan.gen_vdb_xml(lun=lun, xfersize=xfersize, align=align, offset=offset, rdpct=rdpct, seekpct=seekpct)
vdb_xml = osan.gen_vdb_xml(lun=lun, xfersize=xfersize, align=align, offset=offset, seekpct=seekpct, rdpct=rdpct)
print vdb_xml
#运行vdbench
