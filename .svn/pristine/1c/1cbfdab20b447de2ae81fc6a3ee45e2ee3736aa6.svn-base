...
def case():
    ...
    if "200 OK" in opt1 and "200 OK" in opt2 and md5_o == opt_l1[1] and "403" in opt_l1[0]\
        and "FULL_CONTROL" == opt_l2[0][0] and opt_l2[1] == md5_o \
            and "200 OK" in opt_l2[2] and "403" in opt_l2[3]:
        pass
    else:
