...
def run_dd(arg=0):
    ...
    msg=env_manage_lun_manage.Reliable_osan.dd_command(client_ip1,luns[0],'4M','300',need_judge=1)

    env_manage_lun_manage.assert_ins.assertIN("No space left on device",msg)
