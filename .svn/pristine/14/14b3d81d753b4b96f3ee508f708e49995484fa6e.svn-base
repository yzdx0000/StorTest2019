...
def executing_case():
    ...
    # create_file
    create_file_path = nas_common.ROOT_DIR + "nas_16-0-4-75_dir"
    # create_smb_export
    export_name = "nas_16_0_4_75_smb_export_name"
    # add_smb_export_auth_clients
    smb_export_auth_clients_name_1 = "nas_16-0-4-75_user_1"
    smb_export_auth_clients_name_2 = "nas_16-0-4-75_group"
    ...
    if check_result5["detail_err_msg"] != "":
        log.error(("%s Failed") % FILE_NAME)
        raise Exception(("%s Failed") % FILE_NAME)
    result2 = check_result5["result"][0]
    ...
    if check_result6["detail_err_msg"] != "":
        log.error(("%s Failed") % FILE_NAME)
        raise Exception(("%s Failed") % FILE_NAME)
    result3 = check_result6["result"][0]

    check_result7 = nas_common.update_smb_export_auth_client(auth_client_id=result2,
                                                             run_as_root="false",
                                                             permission_level="rw")
    ...
    check_result8 = nas_common.update_smb_export_auth_client(auth_client_id=result3,
                                                             run_as_root="false",
                                                             permission_level="ro")
    ...
    check_result9 = nas_common.get_smb_export_auth_clients(export_ids=result1)
    smb_export_auth_clients = check_result9["result"]["smb_export_auth_clients"]
