...
def os_error(arg=3):
    ...
    ReliableTest.run_kill_process(node_ip1, "oSan")  # 将源节点oSan进程故障
...
def case():
    ...
    log.info("step3:节点重启完成后，数据修复过程中将oSan进程故障,主机端执行vdbench -f mix-R-Align.conf -jro;校验数据一致性 ...")
