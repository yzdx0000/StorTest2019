...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：11-0-1-31_su 目录用户inode数配额硬阈值之su方式
#######################################################
...
def executing_case():
    ...
    if total_inodes != 2000:
        ...
        log.error("11-0-1-31_su Failed")
        raise Exception("11-0-1-31_su Failed")
    else:
        log.info("11-0-1-31_su Succeed")
    return
...
class Quota_Class_11_0_1_31_su():
    def quota_method_11_0_1_31_su(self):
