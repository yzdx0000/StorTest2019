 ...
 * contents of ACL.xs. Do not edit this file, edit ACL.xs instead.
 *
...
XS(XS_Linux__ACL_getfacl); /* prototype to pass -Wmissing-prototypes */
XS(XS_Linux__ACL_getfacl)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_Linux__ACL_setfacl); /* prototype to pass -Wmissing-prototypes */
XS(XS_Linux__ACL_setfacl)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 2)
       croak_xs_usage(cv,  "filename, acl_hashref, ...");
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
	SV *	filename = ST(0);
...
extern "C"
#endif
XS(boot_Linux__ACL); /* prototype to pass -Wmissing-prototypes */
XS(boot_Linux__ACL)
{
#ifdef dVAR
    dVAR; dXSARGS;
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXS("Linux::ACL::getfacl", XS_Linux__ACL_getfacl, file);
        newXS("Linux::ACL::setfacl", XS_Linux__ACL_setfacl, file);
#if (PERL_REVISION == 5 && PERL_VERSION >= 9)
  if (PL_unitcheckav)
