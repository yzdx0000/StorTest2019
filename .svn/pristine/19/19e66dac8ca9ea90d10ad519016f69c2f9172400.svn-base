...
def case():
    ...
    obj_web_access.create_subnet(quota_common.QUOTA_ACCESS_ZONE,
                                 ...
                                 svip,
                                 svip_mask,
                                 [get_config.get_web_eth_name_no_ip()],
                                 get_config.get_vip_domain_name()[0],
                                 vip_address)

    # 删除vip池
    obj_web_access.delete_vip_pool(quota_common.QUOTA_ACCESS_ZONE, subnet_name, get_config.get_vip_domain_name()[0])
