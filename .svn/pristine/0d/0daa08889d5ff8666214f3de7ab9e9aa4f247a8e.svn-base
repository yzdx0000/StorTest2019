...
#   非admin域管理员连接测试
# @steps:
#   1、集群添加ad认证,填写正确的域名、dnsIP、非ADMIN管理员账户和管理员密码；
...
def executing_case():
    ...
    domain_admins_username = nas_common.AD_ADMIN_USER_NAME_1   # 注：autoadminuser1是AD域的用户，也在Domain Admins安全组中
    ...
    access_zone_name = 'nas_16_0_0_10_access_zone_name'

    msg = nas_common.add_auth_provider_ad(name=auth_provider_ad_name,
                                          domain_name=domain_name,
                                          dns_addresses=dns_addresses,
                                          username=domain_admins_username,
                                          password=password,
