...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：11-0-1-42 目录用户逻辑空间配额建议阈值之chown方式
#######################################################
...
def executing_case():
    ...
    if total_file_size != quota_common.FILE_SIZE_3G:
        ...
        log.error("11-0-1-42 Failed")
        raise Exception("11-0-1-42 Failed")
    else:
        log.info("11-0-1-42 Succeed")
    return
...
class Quota_Class_11_0_1_42():
    def quota_method_11_0_1_42(self):
