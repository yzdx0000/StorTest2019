...
#    3、针对父目录配置inode硬阈值100;子目录inode软阈值100
#    4、通过nfs客户端先在目录中写入110个文件，预计只能写100个
# @changelog：
####################################################################################
...
NAS_TRUE_PATH = os.path.join(nas_common.NAS_PATH, FILE_NAME)             # /mnt/volume/nas_test_dir/quota_nas_3
