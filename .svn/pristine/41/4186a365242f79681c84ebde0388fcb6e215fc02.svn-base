...
def network_error2(arg=1):
    ...
    fault_node_id2 = env_manage_repair_test.break_down.get_node_id_by_ip(n_ip=node_ip1)

    fault_eth_list2 = error.get_data_eth(fault_node_id2)
    log.info(fault_eth_list2)
    env_manage_repair_test.Reliable_osan.net_flash_test(node_ip1, fault_eth_list2)
