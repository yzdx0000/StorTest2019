...
def executing_case():
    """
        1、创建一个共享路径为volume:/export的FTP共享；
        2、再创建一个相同共享路径的FTP共享；
    :return:
    """
    ...
    # create_file，export_path重复性检查
    duplicate_file_path = nas_common.ROOT_DIR + "nas_16-0-4-136_dir"
    # export_name
    export_name1 = "nas_16_0_4_136_ftp_export_name_1"
    export_name2 = "nas_16_0_4_136_ftp_export_name_2"

    check_result1 = nas_common.create_file(path=duplicate_file_path)
    ...
    check_result2 = nas_common.create_ftp_export(access_zone_id=access_zone_id,
                                                 ...
                                                 export_path=duplicate_file_path)
    ...
    if exe_info['result']['total'] != 1:
        common.except_exit('create ftp info is incorrect !!!')
