...
#    通过硬链接修改快照内容
#@steps:
#    1、对/mnt/liyao/snap/test_file1创建硬链接/mnt/liyao/snap1/test_file_hd
#    2、对/mnt/liyao/snap/创建快照a1
#    3、通过/mnt/liyao/snap1/test_file_hd修改文件内容
...
SNAP_TRUE_PATH = os.path.join(snap_common.SNAP_PATH, FILE_NAME)             #/mnt/liyao/snap/snap_13_0_2_35
CREATE_SNAP_PATH = os.path.join(snap_common.SNAP_PATH_BASENAME, FILE_NAME)  #/snap/snap_13_0_2_35


def case():
    # 创建子目录/mnt/liyao/snap/snap_13_0_2_35/test_dir
    test_dir=os.path.join(SNAP_TRUE_PATH, 'test_dir')
    cmd='mkdir %s'% test_dir
    common.run_command(snap_common.CLIENT_IP_1, cmd)

    # 创建文件/mnt/liyao/snap/snap_13_0_2_35/test_dir/test_file1
    test_file1 = os.path.join(test_dir, 'test_file1')
    cmd = "echo 'hello, world!'> %s" % test_file1
    common.run_command(snap_common.CLIENT_IP_1, cmd)

    # 创建子目录/mnt/liyao/snap/snap_13_0_2_35/test_dir_1
    test_dir_1 = os.path.join(SNAP_TRUE_PATH, 'test_dir_1')
    cmd = 'mkdir %s' % test_dir_1
    common.run_command(snap_common.CLIENT_IP_1, cmd)

    # 创建硬链接/mnt/liyao/snap/snap_13_0_2_35/test_dir_1/test_file1_hd
    test_file1_hd = os.path.join(test_dir_1, 'test_file1_hd')
    ...
    # 通过硬链接/mnt/liyao/snap/snap_13_0_2_35/test_dir_1/test_file1_hd 修改源文件内容
