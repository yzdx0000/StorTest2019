...
def executing_case():
    """
        1、创建一个关闭guest的smb共享；
        pscli --command=create_smb_export --access_zone_id=1 --export_name=smb_2 --export_path=parastor:/smb_2/ --enable_guest=false
    ...
    check_result2 = nas_common.create_smb_export(access_zone_id=access_zone_id,
                                                 export_name="nas_16_0_4_39_smb_export_name",
