...
if ($result_1)
{    
    echo "testcase $st_case allow Write success"
}
else
{
    echo "testcase $st_case allow Write failed"
    echo "failed from $testuser allow Write failed $file_path."   
}
