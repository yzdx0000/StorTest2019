...
def executing_case():
    ...
    if check_result["err_no"] == 0:
        ...
        log.error("11-0-2-34 Failed")
        raise Exception("11-0-2-34 Failed")
    else:
        log.info("11-0-2-34 Succeed")
    return
...
class Quota_Class_11_0_2_34():
    def quota_method_11_0_2_34(self):
