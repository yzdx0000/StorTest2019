...
#    3、客户端1移动/mnt/parastor/snap/成/mnt/parastor/snap1/，对/mnt/parastor/snap1/创建快照a2；
...
SNAP_TRUE_PATH = os.path.join(snap_common.SNAP_PATH, FILE_NAME)             #/mnt/volume1/snap/snap_13_0_2_18
CREATE_SNAP_PATH = os.path.join(snap_common.SNAP_PATH_BASENAME, FILE_NAME)  #/snap/snap_13_0_2_18
...
def case():
    ...
    test_dir_new_1 = os.path.join(snap_2,'test_dir_1')
    cmd = 'mv %s %s' % (snap_1, snap_2)
    common.run_command(snap_common.CLIENT_IP_1, cmd)
    ...
    snap_test_file_new_1 = os.path.join(snap_path, 'test_dir_1', 'test_file_1')
    snap_test_file_new_2 = os.path.join(snap_path, 'test_dir_1', 'test_file_2')
