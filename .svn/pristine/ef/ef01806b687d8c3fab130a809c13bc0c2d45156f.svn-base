...
def case():
    ...
    wrong_disk_uuids = 0
    usage = 'DATA'
    rc, stdout = common.add_disks(wrong_node_id, wrong_disk_uuids, usage)
    common.judge_rc_unequal(rc, 0, 'adding a disk failed !!!')
    ...
    code = '0x02060006'
    description = 'check result success'
    ...
    common.judge_rc(rc, 0, "add disk failed")
