...
3）查询主机组信息pscli --command=get_host_groups
...
def case():
    ...
    decorator_func.judge_target(
        env_manage_lun_manage.osan.get_option_single(s_ip=node_ip1, command="get_host_groups", indexname="host_groups"
                                                     , argv2="name", ids="ids", argv1=hg_id),
        'myhostgroup1')
