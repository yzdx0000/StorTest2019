...
# Date: 2018-09-03
# @summary：
#    用户 父目录软阈值2G，宽限时间60秒，子目录软阈值1G，宽限时间60秒，子目录创建1100M文件开始计时，
...
def case():
    ...
    time.sleep(10)
    if LARGE_BS:
        quota_common.creating_files_by_designated_user_or_group(quota_common.CLIENT_IP_1, dir1_1, 1, 200, 'f',
                                                                quota_common.QUOTA_USER)
    else:
        quota_common.creating_files_by_designated_user_or_group(quota_common.CLIENT_IP_1, dir1_1, 200, 1, 'f',
                                                                quota_common.QUOTA_USER)
    dir_size = quota_common.user_or_group_total_file_size(quota_common.CLIENT_IP_1, dir1_1, quota_common.QUOTA_USER)
