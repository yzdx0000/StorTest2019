...
#######################################################
# 脚本作者：姜晓光
# 脚本说明：16-0-x-x 修改OS2_style_ex_attrs
#######################################################
...
def executing_case():
    """
        1、修改smb共享的enable_os2style_ex_attrs配置；
        pscli --command=update_smb_export --id=x --enable_os2style_ex_attrs=true
        pscli --command=update_smb_export --id=x --enable_os2style_ex_attrs=false
    :return:
    """
    ...
    create_file_path = nas_common.ROOT_DIR + "nas_16-0-4-52_dir"
    export_name = "nas_16_0_4_52_smb_export_name"
