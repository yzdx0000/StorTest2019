...
def executing_case():
    """
        1、创建一个最大传输速率为10M的FTP共享；
        pscli --command=create_ftp_export --access_zone_id=1 --export_name=ftp_export_name --export_path=volume:/export/dir --bandwidth_limit=10
        2、修改上述FTP共享的最大传输速率为0，即不限制；
        pscli --command=update_ftp_export --id=x --bandwidth_limit=0
    :return:
    """
    ...
    # create_ftp_export
    export_name = "nas_16_0_4_148_ftp_export_name"
    ...
    check_result3 = nas_common.create_ftp_export(access_zone_id=access_zone_id,
                                                 ...
                                                 upload_local_max_rate=100,
                                                 download_local_max_rate=100)
    ...
    check_result5 = nas_common.update_ftp_export(export_id=result,
