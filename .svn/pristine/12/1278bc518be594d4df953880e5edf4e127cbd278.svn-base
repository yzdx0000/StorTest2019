...
# Date  :2018-8-8
"""
测试内容:副本下，数据修复过程中，副本下，数据修复过程中，修复源节点数据网闪断
步骤:
...
def disk_error(arg=0):
    ...
    for i in fault_eth_list:
        env_manage_repair_test.Reliable_osan.net_flash_test(node_ip2, i, 10, 30)
...
def case():
    ...
    log.info("step3:插回被拔出的磁盘触发修复,修复过程中将源节点数据网闪断10秒,主机端执行vdbench -f mix-R-Align.conf -jro;校验数据一致性 ...")
