...
# @steps:
#   1、部署3节点集群环境
#   2、执行create_jobengine_impact，输入参数错误，预期创建失败
...
def case():
    ...
    common.judge_rc(rc, 0, "create jobengine impact failed !!!")

    # 再次执行，触发创建失败事件,预期失败
    common.create_jobengine_impact(impact_info)
    ...
    code = '0x02050012'
    description = 'adding jobengine impact'
