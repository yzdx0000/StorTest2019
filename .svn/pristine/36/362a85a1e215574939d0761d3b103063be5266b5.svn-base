...
def executing_case1():
    ...
    access_zone_name = "access_zone_16_0_2_1"
    node = common.Node()
    ids = node.get_nodes_id()
    access_zone_node_id_16_0_2_1 = ','.join(str(p) for p in ids)
    node_name_list = nas_common.get_node_name_list(ids)
    cmd = "create_access_zone "
    msg1 = nas_common.create_access_zone(node_ids=access_zone_node_id_16_0_2_1, name=access_zone_name)
