...
# -*- coding:utf-8 -*-
#**********************************************#
# 标题：功能测试，用例编号29-0-17-52
# 使用方法：python 29-0-17-52_wjl.py
# 在http模式下，使用错误sig设置对象的acl。
# 作者：王建磊
# 创建时间：2018/10/09
#**********************************************#
import sys
...
def case():
    ...
    log.info("******错误sig设置的读权限,start.******")
    rc1, opt1 = s3_common.set_object_acl(bucket_name1, object_name1, ak1, account_id1, email1,
                                         account_id2, email2, ACL_TYPE, "   ")
    rc2, opt2 = s3_common.set_object_acl(bucket_name1, object_name1, ak1, account_id1, email1,
                                         account_id2, email2, ACL_TYPE, sig + "111#%SWDF")
    rc3, opt3 = s3_common.set_object_acl(bucket_name1, object_name1, ak1, account_id1, email1,
                                         account_id2, email2, ACL_TYPE, "$%$^SDF@#")
    rc4, opt4 = s3_common.set_object_acl(bucket_name1, object_name1, ak1, account_id1, email1,
                                         account_id2, email2, ACL_TYPE, "sfdgdsfghretihdfgkjh")
    log.info("******错误sig设置的读权限,end.******")
