...
def case():
    ...
    rc1, opt1 = s3_common.set_bucket_acl(
        bucket_name1, ak1, account_id1, email1, account_id2, email2, ACL_TYPE, "    ")
    rc2, opt2 = s3_common.set_bucket_acl(
        bucket_name1, ak1, account_id1, email1, account_id2, email2, ACL_TYPE, " " + sig)
    rc3, opt3 = s3_common.set_bucket_acl(
        bucket_name1, ak1, account_id1, email1, account_id2, email2, ACL_TYPE, "123sde")
    rc4, opt4 = s3_common.set_bucket_acl(
        bucket_name1, ak1, account_id1, email1, account_id2, email2, ACL_TYPE, "#$%#$%")
    log.info("******设置的读权限,end.******")
...
# 设置完全权限
    ...
    if tag1 == 0 and tag2 == 0 and tag3 == 0 and tag4 == 0 and tag5 == 0:
        pass
    else:
