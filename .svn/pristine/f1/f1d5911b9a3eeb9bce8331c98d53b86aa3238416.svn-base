...
def case():
    ...
    log.info("step:4.删除lun map,删除lun")
    env_manage.clean_lun_map(node_ip2)
    env_manage.clean_lun(ips=node_ip2)
    log.info("step:5. %s 节点开机 节点类型%s,节点ID or IPMI IP: %s" % (node_ip1, os_type, info))
