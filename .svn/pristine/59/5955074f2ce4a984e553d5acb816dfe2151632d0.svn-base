...
def executing_case():
    """
        1、创建一个共享路径为volume:/export的smb共享；
        2、再创建一个相同共享路径的smb共享；
    :return:
    """
    ...
    check_result3 = nas_common.create_smb_export(access_zone_id=access_zone_id,
                                                 export_name="nas_16_0_4_30_smb_export_name_1",
                                                 export_path=duplicate_export_path)
    ...
    check_result5 = nas_common.create_smb_export(access_zone_id=access_zone_id,
                                                 export_name="nas_16_0_4_30_smb_export_name_2",
                                                 export_path=duplicate_export_path)
