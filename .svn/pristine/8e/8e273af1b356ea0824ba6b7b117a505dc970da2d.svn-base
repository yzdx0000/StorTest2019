...
def case():
    ...
    '''1>制作创建ip池失败事件'''
    domain_name = "_www.domiantest.com"   # 域名以_开头 不合法的域名
    vip_addresses = "10.2.42.221-222"
    ...
    time.sleep(delay_time)    # 创建ip池失败，延时
    code = '0x02030302'     # 创建ip池失败对应的编号
    description = 'add_vip_address_pool_failed'
    '''创建ip池失败事件码是否在事件列表中'''
