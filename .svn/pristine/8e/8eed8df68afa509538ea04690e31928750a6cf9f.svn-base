...
def up_down():
    log.info("故障点:业务节点A/B/C的各一个数据网卡")
    time.sleep(100)
    log.info("Step4:在步骤3中的业务运行过程中，将业务节点A/B/C数据网络故障,节点:%s,%s,%s" % (fault_node_A_ip, fault_node_B_ip,fault_node_C_ip))
