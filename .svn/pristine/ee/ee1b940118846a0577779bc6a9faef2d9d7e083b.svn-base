...
def executing_case():
    """
        1、连接LDAP认证服务器；
        pscli --command=add_auth_provider_ldap --name=name1 --base_dn="dc=parastor,dc=com" --ip_addresses=10.20.104.180 --bind_dn="cn=root,dc=parastor,dc=com" --bind_password=666666
        2、添加LDAP用户/用户组到NAS客户端的smb用户/用户组；
    ...
    # create_file
    create_file_path = nas_common.ROOT_DIR + "nas_16-0-4-76_dir"
    # create_smb_export
    export_name = "nas_16_0_4_76_smb_export_name"
    # add_smb_export_auth_clients
    smb_export_auth_clients_name_1 = "nas_16-0-4-76_user_1"
    smb_export_auth_clients_name_2 = "nas_16-0-4-76_group"
