...
def case():
    ...
    log.info("step3:先将oJob节点掉电，再插回被拔出的磁盘触发修复,主机端执行vdbench -f mix-R-Align.conf -jro;校验数据一致性 ...")
