...
def executing_case():
    ...
    4、修改ip_addresses；
    pscli --command=update_auth_provider_nis --id=x --ip_addresses=250.250.250.250
    :return:
    """
    log.info("（2）executing_case")

    # for add_auth_provider_nis
    auth_provider_nis_name = 'nas_16_0_7_18_nis_auth_name'
    ...
    # node_ids = "1,2,3"
    access_zone_name = 'nas_16_0_7_18_access_zone_name'
