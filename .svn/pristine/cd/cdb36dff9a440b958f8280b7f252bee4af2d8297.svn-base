...
# Date: 2018-08-24
# @summary：
#   正常连接AD认证服务器开启rfc2307映射（映射值边界测试）
# @steps:
...
def executing_case():
    ...
    access_zone_name = 'nas_16_0_0_15_access_zone_name'

    for i in range(1, count, 1):
        auth_provider_ad_name = "nas_16_0_0_15_ad_auth_name_" + str(i)
        if i < 5:
