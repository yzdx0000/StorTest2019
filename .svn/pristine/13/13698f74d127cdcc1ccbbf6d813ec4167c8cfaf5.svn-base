...
# Date: 2018-09-03
# @summary：
#    用户 对父目录a创建硬阈值配额3000，在a下创建目录b硬阈值配额2000，在目录b创建目录c硬阈值配额1000，
...
#    4.创建子目录FILENAME/nesting1_1/配额,硬阈值2000,等待配额状态为work
#    5.创建子目录FILENAME/nesting1_1/nesting2_1配额,硬阈值1000,等待配额状态为work
#    6.子目录nesting2_1下写2001个文件预期total_inode=1000
...
def case():
    ...
    log.info("4> 创建子目录FILENAME/nesting1_1/配额,硬阈值2000,等待配额状态为work")
    ...
    log.info('6> 子目录nesting2_1下写2001个文件预期total_inode=1000')
    ...
    dir2_1_inode = quota_common.user_total_inodes(quota_common.CLIENT_IP_1, dir2_1, quota_common.QUOTA_USER)
    ...
    log.info('8> 父目录FILENAME创建1001个文件，预期total_inode=3000')
    ...
    dir0_inode = quota_common.user_total_inodes(quota_common.CLIENT_IP_3, dir0, quota_common.QUOTA_USER)
    if dir0_inode != 3000:
