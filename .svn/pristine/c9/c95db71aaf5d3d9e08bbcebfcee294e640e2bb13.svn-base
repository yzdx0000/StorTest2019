...
def case():
    ...
    if "200 OK" in opt1 and "200 OK" in opt2 and "READ_ACP" == opt_l1[2][0] and "403" in opt_l1[0]\
            and "200 OK" in opt_l1[1] and "200 OK" in opt_l2[0] and "200 OK" in opt_l2[1]\
