...
def case():
    az_id = env_manage_lun_manage.osan.create_access_zone(s_ip=node_ip1, node_id=node_ids,
                                                          name='qwertyuiopasdfghjklzxcvbnm12345')
    decorator_func.judge_target(
        env_manage_lun_manage.osan.get_option_single(s_ip=node_ip1, command="get_access_zones", indexname="access_zones"
                                                     , argv2="name", ids="ids", argv1=az_id),
