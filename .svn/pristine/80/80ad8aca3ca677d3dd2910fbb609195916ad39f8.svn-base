...
sv_ip = osan.set_vip(s_ip="10.22.129.3")
osan.create_subnet(s_ip="10.22.129.3",sv_ip=sv_ip)
#osan.create_access_zone(s_ip="10.22.129.3",node_id="1",name="zone")
#osan.vdb_write(sd="default")
#osan.vdb_write(sd="sd1",lun="/dev/sdf",wd="wd1",offset=1024,align=1024,rdpct=10,seekpct=10)
#osan.vdb_write(sd="sd2",lun="/dev/sde",wd="wd2",offset=1024,align=1024,rdpct=10,seekpct=10)
#osan.create_access_zone(s_ip=deploy_ips[0],node_id='1,2,3',name="dws")
'''
