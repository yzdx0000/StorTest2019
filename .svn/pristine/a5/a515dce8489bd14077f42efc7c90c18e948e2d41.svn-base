...
# -*- coding:utf-8 -*-
#**********************************************#
# 标题：功能测试，用例编号29-0-17-65
# 使用方法：python 29-0-17-65_wjl.py
# 在http模式下，错误sig复制对象
# 作者：王建磊
# 创建时间：2018/10/10
#**********************************************#
...
def case():
    ...
    rc1, opt1 = s3_common.cp_object(
        bucketname2, objectname, ak1, bucketname, objectname, "   ")
    rc2, opt2 = s3_common.cp_object(
        bucketname2, objectname, ak1, bucketname, objectname, "asdgfsh")
    rc3, opt3 = s3_common.cp_object(
        bucketname2, objectname, ak1, bucketname, objectname, sig + "asdsdf")
    rc4, opt4 = s3_common.cp_object(
        bucketname2, objectname, ak1, bucketname, objectname, "#$%^$&")
