...
def case():
    ...
    code = '0x01030012'
    description = 'oJob process'
    # event_common.check_events_result(start_time, code, description)

    cmd = "mv /home/parastor/bin/oJob /home/parastor/bin/oJob_bk"
    rc, stdout = common.run_command(node_ip, cmd)
    common.judge_rc(rc, 0, "mv oPara wrong")
    make_fault.kill_process(node_ip, process_name)
    event_common.check_alarms_result(code, "oJob alarm check right")
    cmd1 = "mv /home/parastor/bin/oJob_bk /home/parastor/bin/oJob"
