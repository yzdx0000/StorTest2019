...
#   6、通过命令行修改vip地址池；
#   pscli --command=update_vip_address_pool --id=x --ip_failover_policy=IF_CONNECTION_COUNT
...
def executing_case():
    ...
    access_zone_name = 'nas_16_0_3_66_access_zone_name'
    # for create_subnet
    subnet_name = 'nas_16_0_3_66_subnet_name'
    ...
    ip_failover_policy = nas_common.IP_IF_CONNECTION_COUNT
